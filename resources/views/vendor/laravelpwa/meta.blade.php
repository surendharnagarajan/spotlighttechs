...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/serviceworker.js', {
            ...
            console.log('Spotlight PWA: ServiceWorker registration successful with scope: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('Spotlight PWA: ServiceWorker registration failed: ', err);
        });
    }
</script>