            ...
            <div class="row">
                <div class="col-xl-7 col-lg-9">
                    <div class="slider-cont">
                        <h1 data-animation="bounceInLeft" data-delay="1s">Welcome to Spotlight Tech</h1>
                        <p data-animation="fadeInUp" data-delay="1.3s">To Gain Employability.. Every Course For Everybody..!</p>
                        <ul>
    ...
    <div class="single-slider bg_cover pt-150" style="background-image: url(images/slider/s-2.jpg)" data-overlay="4">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 col-lg-9">
                    <div class="slider-cont">
                        <h1 data-animation="bounceInLeft" data-delay="1s">Choose the right education</h1>
                        <p data-animation="fadeInUp" data-delay="1.3s">To Gain Employability.. Every Course For Everybody..!</p>
                        <ul>
                            <li><a data-animation="fadeInUp" data-delay="1.6s" class="main-btn" href="#">Read More</a></li>
                        </ul>
